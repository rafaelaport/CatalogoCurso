...
namespace CatalogoCurso.Application.Curso.Dto
{
    ...
    public record CursoOutputDto(
        ...
        string Avaliacao,
        string Certificacao,
        ModalidadeEnsinoOutputDto ModalidadeEnsino,
        TipoCursoOutputDto TipoCurso,
        ModalidadeEducacaoOutputDto ModalidadeEducacao,
        EixoTecnologicoOutputDto EixoTecnologico,
        SegmentoOutputDto Segmento,
