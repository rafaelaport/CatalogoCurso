...
{
    public class EixoTecnologicoMapping : IEntityTypeConfiguration<EixoTecnologico>
    {
        public void Configure(EntityTypeBuilder<EixoTecnologico> builder)
        {

            builder.ToTable("EixoTecnologico");
