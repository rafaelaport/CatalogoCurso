...
{
    public class ModalidadeEducacaoRepository : Repository<ModalidadeEducacao>, IModalidadeEducacaoRepository
    {
        public ModalidadeEducacaoRepository(CatalogoCursoContext context) : base(context)
        {
        }
    }
}
